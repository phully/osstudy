...
void kGetDynamicMemoryInformation(QWORD *powDynamicMemoryStartAddress,QWORD *pqwDynamicMemoryTotalSize,QWORD * pqwMetaDataSize,QWORD pqwUsedMemorySize);
