...
#define MP_INTERRUPT_INT                            0
#define MP_INTERRUPT_NMI                            1
#define MP_INTERRUPT_SMI                            2
#define MP_INTERRUPT_EXTINT                         3
...
#define MP_INTERRUPT_FLGAS_EDGETRIGGERED            0x04
...
typedef struct kMPConfigurationTableHeaderStruct
{
    ...
    WORD wOEMTableSize;
    WORD wEntryCount;
    DWORD dwMemoryMapIOAdressOfLocalAPIC;
...
typedef struct kLoadInterruptEntryStruct
{
    BYTE bEntryType;
    BYTE bInterruptType;
    WORD wInterruptFlags;
